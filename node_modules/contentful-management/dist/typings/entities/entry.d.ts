...
import { DefaultElements, Collection, KeyValueMap, EntityMetaSysProps, MetadataProps, MakeRequest, CollectionProp } from '../common-types';
...
export declare const wrapEntryCollection: (makeRequest: {
    ...
    }): Promise<CollectionProp<SnapshotProps<EntryProps<any>>>>;
    (opts: {
        entityType: "Snapshot";
        action: "getForEntry";
    } & {
    ...
    }): Promise<CollectionProp<SnapshotProps<import("./content-type").ContentTypeProps>>>;
    (opts: {
        entityType: "Snapshot";
...
}, data: CollectionProp<EntryProps<Record<string, any>>>) => Collection<Entry, EntryProps<Record<string, any>>>;
export {};
